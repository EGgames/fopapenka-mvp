Feature: Ver código de invitación y regenerar
  ...
  Scenario: El código regenerado es único
    Given que "AdminUser" regenera el código de invitación
    Then el nuevo código debería ser alfanumérico en mayúsculas
    And el nuevo código debería tener al menos 6 caracteres
    And ningún otro código de penca activa debería coincidir
